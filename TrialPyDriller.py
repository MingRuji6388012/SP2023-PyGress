...
#     time.sleep(5)  # Sleep for 10 seconds after processing each project
...
# # Function to record project website and error message into error log
...
# def handle_errors(project_url, error_message):
#     print(f"Error processing repository {project_url}: {error_message}")
#     record_error(project_url, error_message)
